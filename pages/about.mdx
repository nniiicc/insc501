...
INSC 570 introduces you to data collection and analysis techniques commonly used in an Information Science department. 

INSC 501 introduces you to the dominant philosophies (epistemology and ontology) that shape research in Information Science. 

Drawing on a metaphor from computing we can think of INSC 570 as a software layer, and INSC 501 as the operating system.  
In other words, INSC 501 provides an interface between the real world (hardware) and the empirical methods (software) we use to produce reliable new knowledge about the world.  
